      ...
      <div className=" w-10/12 lg:pt-10 md:pt-28 pt-24">
          ...
          <Image
            ...
            <div className="flex flex-col">
              ...
              Kirana melanjutkan kisah petualangannya dengan langkah-langkah penuh semangat, 
              kali ini diiringi oleh temannya, Agam, orang asli Medan. Medan, dengan kekayaan kuliner dan keindahan alamnya, 
              menjadi destinasi yang tak terlupakan bagi pasangan petualang ini. 
              Di bawah langit biru Sumatra, Kirana dan Agam membenamkan diri dalam pengalaman yang 
              menggoda selera dan memukau mata.
              </p>
          ...
          <div className="flex lg:flex-row flex-col justify-center items-center">
            ...
            <div className="flex flex-col">
              ...
              Kota Medan, sebagai pusat ekonomi dan budaya di Sumatra Utara, Indonesia, 
              memancarkan keberagaman dalam segala aspek kehidupan. Dengan penduduk yang heterogen, 
              kota ini menjadi cermin harmoni antara berbagai elemen budaya, suku, dan agama.
              </p>
