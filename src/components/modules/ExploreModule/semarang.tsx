    ...
    <div className=" w-10/12 lg:pt-10 md:pt-28 pt-24">
        ...
        <Image
          ...
          <div className="flex flex-col">
            ...
            Kirana memulai petualangannya di kota Semarang, tempat di mana sejarah dan keindahan budaya menyatu harmonis. 
            Terpesona oleh arsitektur kolonial yang megah. Tempat pertama yang di kunjungi oleh Kirana adalah Klenteng Sam Poo Kong.
            </p>
        ...
        <div className="flex lg:flex-row flex-col justify-center items-center">
          ...
          <div className="flex flex-col">
            ...
            Sampookong, atau Klenteng Gedung Batu, adalah klenteng bersejarah di Semarang, 
            didirikan pada abad ke-18. Dengan arsitektur khas dan ornamen warna-warni, klenteng 
            ini menjadi pusat kegiatan keagamaan dan budaya masyarakat Tionghoa. Selain sebagai 
            tempat ibadah, Sampookong menyimpan jejak sejarah Semarang, menjadi saksi perjalanan 
            waktu dan pusat perayaan Cap Go Meh setiap tahunnya.
            </p>
